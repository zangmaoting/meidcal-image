...
Original file is located at
    https://colab.research.google.com/drive/1TfOxrx893ghLs2q27ZkAHBlrjQ186BHt
"""
...
class UNet(nn.Module):
    def __init__(self, in_channels=4, out_channels=3, features=[64, 128, 256, 512]):
        ...
        for feature in reversed(features):
            ...
            self.decode.append(DoubleConv(feature*2, feature))     # adds 4 conv blocks using reversed features
